...
class RatingStartContenido extends Component {
    ...
    UpdateRating(rating, id) {
        ...
        this.reviewSend.id_CREA = this.props.id_CREA;
    ...
    async sendReview() {
        if (this.validateSelectedRating()) {
            if(this.state.comment != null){
                this.commentSend.id_CREA = this.props.id_CREA;
    ...
    async mostrarBotonCalificar(){
        const validarCalificar = await API.getNivelSatisfaccion(this.props.ipconfig, this.props.id_CREA,this.props.student.id_estudiante);
...
export default connect(mapStateToProps)(RatingStartContenido);
